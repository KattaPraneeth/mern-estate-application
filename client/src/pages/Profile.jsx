    ...
    <div className="pd-3 max-w-lg mx-auto">
      ...
      <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
        ...
        <input
          ...
          onChange={handleChange}
        />
        <button disabled={loading} className="bg-slate-700 text-white rounded-lg p-3 hover:opacity-95 uppercase disabled:opacity-80">
      ...
      <p className="text-green-700 my-2">{updateSuccess ? 'User Update Successfully!': ''}</p>
    </div>
  );
}
